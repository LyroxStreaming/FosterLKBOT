...
module.exports = {
 ...
 .setColor(ee.color)
            ...
            embeduserinfo.setAuthor(" <:FosterBot:1191014868267049041> Information about:   " + member.user.username + "#" + member.user.discriminator, member.user.displayAvatarURL({ dynamic: true }), "https://discord.gg/FQGXbypRf8")
