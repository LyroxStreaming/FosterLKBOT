    ...
    async (giveaway, reactor, messageReaction) => {
        ...
        try {
            ...
            reactor.send(
                new MessageEmbed()
                    .setTimestamp()
                    .setTitle(` <:FosterBot:1191014868267049041>Your Entry Approved || You Have Chance to Win`)
                    .setDescription(
            ...
            reactor.send(new MessageEmbed()
                .setTimestamp()
                .setTitle(" <:FosterBot:1191014868267049041> Your Entry Denied | Databse Entery Not Found & Returned!")
                .setDescription(
